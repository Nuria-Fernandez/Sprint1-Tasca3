...
public class Programa {
    ...
    public static void arrancarPrograma(){
        ...
        for(int i = 0; i < 10; i++) {
            ...
            listaPaises.remove(paisJugado);//elimina pais jugado para que no me salga duplicado
        }
    ...
    private static void escribirArchivo(String nombre, int puntuacion){
        ...
        try(FileWriter datosUsuario = new FileWriter("src/main/java/n1exercici3/Clasificación.txt", true);
